...
async function run(timeframe){
 ...
 for(let index=0;index<candles.length;index++){
  ...
  // Keep all trigger opportunities as diagnostics, but record only the first fully-valid candidate selected by baseline semantics.
